...
# ===============================================================================
resource "aws_chatbot_slack_channel_configuration" "chatbot_audit_notification_for_slack" {
  configuration_name          = "${local.project}-${local.env}-chatbot-audit-notification-for-slack"
  ...
  tags = {
    Name = "${local.project}-${local.env}-chatbot-audit-notification-for-slack"
  }
}
